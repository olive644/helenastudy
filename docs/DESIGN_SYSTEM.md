...
- Cabeçalho móvel: Mais à esquerda, seletor de aparência e foto circular à direita. O seletor de aparência também é usado no desktop. A barra inferior mantém Praticar elevado em papel roxo facetado, com ícone creme. Perfil usa silhueta autoral de pessoa em papel grafite com facetas roxas, sem estrela e sem foto do usuário, reservada para configurações futuras de perfil, conta e aplicativo.
