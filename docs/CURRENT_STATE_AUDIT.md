...
liberado, acompanhando o progresso local, enquanto um cenário de rua e trilha em papel recortado ocupa o fundo de cada mundo. A entrada mantém a transição para a trilha.
