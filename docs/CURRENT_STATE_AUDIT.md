...
# Marca NoteOLI, setembro de 2026

A marca exibida na interface, nos metadados e nos materiais públicos passou a ser NoteOLI. Helena continua sendo o nome da gatinha e da assistente; identificadores internos antigos foram preservados para não quebrar dados locais, links e integrações existentes.
