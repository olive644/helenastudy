...
// Controles de áudio sincronizados acrescentam menos de 3 KiB. O modo projetor
// protegido acrescenta menos de 5 KiB. A entrada inicial mantém 222 KiB.
const MAX_TOTAL_JS_BYTES = 405 * 1024;
