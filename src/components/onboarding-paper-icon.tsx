...
export function PaperArrow({ back = false }: { back?: boolean }) {
  return (
    <svg
      className="onboarding-paper-arrow"
      viewBox="0 0 40 40"
      aria-hidden="true"
      focusable="false"
    >
      <g transform={back ? "translate(40 40) rotate(180)" : undefined}>
        <path fill="#39264F" d="m5 17 15-1-1-8 17 13-17 14 1-9-15 1Z" />
        <path fill="#FACC15" d="m4 13 16 1-2-9 18 14-17 12 1-10-16 2Z" />
        <path fill="#FFE88D" d="m4 13 16 1-2-9 18 14-15-2Z" />
        <path fill="#DEA719" d="m21 17 15 2-17 12Z" />
      </g>
    </svg>
  );
}
